    ...
    en: {
      "Game Rules & Strategy": [
        ...
        },
        {
            ...
            options: [
            "When a baserunner returns to their base after a fielder catches a hit ball. The baserunner must touch the base before running to the next base. ",
            "When it is time to swap out a pitcher for another pitcher.",
            "When a fielder has the ball in their glove and touches a baserunner.",
            "When a pitcher throws at a batter.",
            ],
            correctAnswer: 0,
            explanation:
        ...
        },
        {
            ...
            options: [
            "When a runner is forced to advance to the next base because the batter becomes a runner and the defense gets the ball to that base before the runner.",
    ...
    es: {
      "Game Rules & Strategy": [
          ...
          },
          {
              ...
              options: [
                  "Cuando un corredor regresa a su base después de que un defensor atrapa una bola de aire. El corredor debe tocar la base antes de correr a la siguiente base.",
                  "Cuando es hora de cambiar a un lanzador por otro.",
                  "Cuando un fildeador tiene la bola en su guante y toca a un corredor.",
                  "Cuando un lanzador le lanza a un bateador."
              ],
              correctAnswer: 0,
          ...
          },
          {
              ...
              options: [
                  "Cuando un corredor está obligado a avanzar a la siguiente base porque el bateador se convierte en corredor y la defensa lleva la bola a esa base antes que el corredor.",
    ...
    "Game Rules & Strategy": [
        {
            ...
            correctAnswer: 0,
            explanation: "主な目的は、塁を回って相手チームより多く得点することです。"
        },
        {
        ...
        },
        {
            ...
            options: [
                ...
                "ダブルプレーやトリプルプレーを狙って、守備 সৈন্যがわざと簡単なフライを落とすことを防ぐためのルール。",
        ...
        },
        {
            ...
            options: [
                "飛球が捕球された後、走者が元の塁に戻り、触れてから次の塁へ進塁すること",
                "タイムを要求すること。",
                "犠牲フライを打つこと",
                "デッドボールを受けること。"
            ],
        ...
        },
        {
            ...
            options: [
                "打者が走者になったために、塁上の走者が次の塁に進まなければならず、野手がその塁に送球し、走者が到達するより先にアウトにすること",
                "投手がフォアボール（四球）を出すこと。",
                "打者が三振すること。",
