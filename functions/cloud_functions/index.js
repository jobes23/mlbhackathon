...
const { setfavorites } = require("./setfavorites")
...
exports.fetchuserdata = functions.https.onRequest(fetchuserdata);
exports.setlanguage = functions.https.onRequest(setlanguage);
exports.setfavorites = functions.https.onRequest(setfavorites);